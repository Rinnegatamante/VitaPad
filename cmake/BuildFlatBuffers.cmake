...
function(build_flatbuffers flatbuffers_schemas
  ...
  set(FLATC flatc)
  set(FLATC_SCHEMA_ARGS --gen-mutable --scoped-enums --no-includes)
  ...
  foreach(schema ${flatbuffers_schemas})
    ...
    if (NOT ${generated_includes_dir} STREQUAL "")
      ...
      add_custom_command(
        ...
        ${include_params}
        -c ${schema}
        DEPENDS ${schema} ${additional_dependencies}
  ...
  # to be built.
  message(STATUS "Creating custom target ${custom_target_name}")
